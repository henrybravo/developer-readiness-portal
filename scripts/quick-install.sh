...
REPO="henrybravo/spec2cloud-agentskills" # default fork; override with --repo (e.g., EmeaAppGbb/spec2cloud)
VERSION="latest"
MODE="full"
TARGET_DIR="."
...
Usage: curl -fsSL https://raw.githubusercontent.com/henrybravo/spec2cloud-agentskills/main/scripts/quick-install.sh | bash -s -- [OPTIONS]

OPTIONS:
  --minimal           Install minimal package (agents and prompts only)
  --version VERSION   Install specific version (default: latest)
  --repo OWNER/NAME   Install from a different repo (default: henrybravo/spec2cloud-agentskills)
  --target DIR        Install to specific directory (default: current)
  --help              Show this help message

EXAMPLES:
  # Default installation (full package, latest version)
  curl -fsSL https://raw.githubusercontent.com/henrybravo/spec2cloud-agentskills/main/scripts/quick-install.sh | bash

  # Minimal installation
  curl -fsSL https://raw.githubusercontent.com/henrybravo/spec2cloud-agentskills/main/scripts/quick-install.sh | bash -s -- --minimal

  # Specific version
  curl -fsSL https://raw.githubusercontent.com/henrybravo/spec2cloud-agentskills/main/scripts/quick-install.sh | bash -s -- --version v1.0.0

  # Custom directory
  curl -fsSL https://raw.githubusercontent.com/henrybravo/spec2cloud-agentskills/main/scripts/quick-install.sh | bash -s -- --target /path/to/project

  # Install from upstream
  curl -fsSL https://raw.githubusercontent.com/henrybravo/spec2cloud-agentskills/main/scripts/quick-install.sh | bash -s -- --repo EmeaAppGbb/spec2cloud
